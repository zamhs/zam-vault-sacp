...
id: "202607190240011"
tipo: modelo_usuario
subtipo: sesgos_detectados
confianza: baja
evidencia_base: []
fecha_ultima_actualizacion: 2026-07-19
estado: vigente
tags: [modelo-usuario, sesgos-detectados]
relacionado_con: ["[[MOC - Modelo del Usuario]]"]
padre: "[[MOC - Modelo del Usuario]]"
---

# Índice - Sesgos Detectados

## Propósito de esta categoría

Aquí se registran sesgos cognitivos específicos observados en el razonamiento o las decisiones del usuario.

## Estado actual

*Pendiente de completar. Esta categoría se irá poblando con evidencia real conforme el sistema aprenda del usuario.*
