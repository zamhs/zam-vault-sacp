...
id: "202607190240006"
tipo: modelo_usuario
subtipo: estilo_cognitivo
confianza: baja
evidencia_base: []
fecha_ultima_actualizacion: 2026-07-19
estado: vigente
tags: [modelo-usuario, estilo-cognitivo]
relacionado_con: ["[[MOC - Modelo del Usuario]]"]
padre: "[[MOC - Modelo del Usuario]]"
---

# Índice - Estilo Cognitivo

## Propósito de esta categoría

Aquí se registra cómo procesa información el usuario: cómo aprende mejor, cómo razona y cómo estructura su pensamiento.

## Estado actual

Poblada inicialmente el 2026-07-19 a partir de un único mensaje extenso de Zam (ver [[2026-07-19 - Zam comparte contexto extenso para el Modelo del Usuario]]). Sigue en desarrollo: esta base se ampliará y contrastará con evidencia de futuras conversaciones.

## Notas relacionadas

- [[Cómo piensa y aprende Zam]]
- [[Metacognición de Zam]]
